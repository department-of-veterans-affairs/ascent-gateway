...
public class AscentGatewayErrorFilterTest {

    private AscentGatewayErrorFilter filter;

    private static Logger testLogger;
    private static ListAppender<ILoggingEvent> testLoggerAppender;
    ...
    public void init() {
        ...
        this.routeLocator = new DiscoveryClientRouteLocator("/", this.discovery,
                this.properties);
        this.filter = new AscentGatewayErrorFilter();
    ...
    public void basicProperties() throws Exception {
        ...
        assertEquals(ERROR_TYPE, this.filter.filterType());
